...
export default function ProductWowsolar60() {
  const detailRef = React.useRef();

  return (
    <Layout pageTitle="Wowsolar-60">
      <div tw="relative">
        <div tw="absolute lg:sticky top-0 flex justify-end z-10 pointer-events-none">
          <div tw="w-full lg:w-1/2 p-16">
            <StaticImage
              alt=""
              loading="eager"
              placeholder="none"
              src="../images/wowsolar60-hero-new.png"
            />
          </div>
        </div>
        <div tw="lg:absolute top-0 left-0 min-h-screen">
          <WowSolarHero
            detailRef={detailRef}
            bannerLogo={<BannerLogo tw="hidden lg:block" />}
            wowsolar={
              <WowSolar
        ...
        <div ref={detailRef}>
          <div tw="px-4 lg:px-0 lg:w-9/12 mx-auto lg:py-48 py-16">
            <DataAndSpecSummary
              ...
              caption={
                <span>
                  The <WowSolar tw="text-px16 lg:text-px28" model={'60'} /> is
                  designed with 3 or 4 light points, bright 160 Lumen lamps, two
            ...
            <div tw="lg:mb-32 mb-8">
              <div tw="text-px16 lg:text-px28 lg:mb-16 mb-8">
                The <WowSolar tw="text-px16 lg:text-px28" model={'60'} /> comes
